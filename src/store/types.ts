...
export type { SubagentSlice, SubagentEntry } from "./subagent-slice.js";
...
import type { SubagentSlice } from "./subagent-slice.js";
...
export type AppState = UiSlice & AgentSurfaceSlice & SessionSlice & AgentDataSlice & ChatSlice & SubagentSlice & ModeSlice & ViewerSlice & WorkspaceSlice & ReplaySlice & PluginSlice & ProjectSlice;
