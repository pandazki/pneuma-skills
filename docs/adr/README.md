...
| [ADR-002](./adr-002-websocket-protocol.md) | WebSocket 协议与消息桥接设计 | Accepted | 2026-02-26 |
...
| [ADR-013](./adr-013-history-sharing-replay.md) | History 分享与重放 | Proposed | 2026-03-20 |

## 约定

- 每个 ADR 独立成文，包含：背景、决策、方案对比、详细设计、影响
- 状态流转: Proposed → Accepted → Deprecated/Superseded
- 基于 [The-Vibe-Company/companion](https://github.com/The-Vibe-Company/companion) 项目的深度调研
