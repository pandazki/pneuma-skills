...
Full design rationale: `docs/reference/viewer-agent-protocol.md` (Sources section) and `docs/archive/proposals/superpowers-plans/2026-04-13-source-abstraction.md`.
...
See `docs/archive/proposals/superpowers-plans/clipcraft-source-migration.md` for a full working example with ClipCraft's `ProjectFile` + three-ref dance removal.
...
- Implementation plan (for the curious): `docs/archive/proposals/superpowers-plans/2026-04-13-source-abstraction.md`
...
- ClipCraft-specific guide (for that mode's author): `docs/archive/proposals/superpowers-plans/clipcraft-source-migration.md`
