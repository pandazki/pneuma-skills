...
| Mode | What it does |
|------|-------------|
| **webcraft** | Live web development with [Impeccable](https://impeccable.style) AI design intelligence — 22 design commands, four visitor modes, responsive preview, export |
...
```bash
# Prerequisites: Bun >= 1.3.14, plus one or more of: Claude Code CLI, Codex CLI, Kimi Code CLI
...
Modes:
  ...
  sprite                       Character sprite sheets, motions, UI loops and Rive exports
