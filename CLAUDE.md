...
- `<!-- pneuma:project-atlas:start -->` / `<!-- pneuma:project-atlas:end -->` — *project sessions only*; full contents of `<projectRoot>/.pneuma/project-atlas.md` (high-density project briefing maintained by the `project-evolve` mode). Only emitted when the atlas file exists.
