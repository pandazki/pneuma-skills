...
**Builtin Modes:** `webcraft`, `doc`, `slide`, `draw`, `diagram`, `illustrate`, `remotion`, `gridboard`, `clipcraft-legacy`, `clipcraft`, `mode-maker`, `evolve`
...
├── modes/{webcraft,doc,slide,draw,diagram,illustrate,remotion,gridboard,clipcraft-legacy,clipcraft,mode-maker,evolve}/
...
|------|-----------|---------------|
| **builtin** | `webcraft`, `doc`, `slide`, `draw`, `diagram`, `illustrate`, `remotion`, `gridboard`, `clipcraft-legacy`, `clipcraft`, `mode-maker`, `evolve` | `modes/<name>/` |
