...
Follow Step 3 in [the shared procedure](../SKILL.md) for frontend registration,
launcher discovery, public documentation, and conditional cloud surfaces.
Public modes belong in the catalogs and CLI usage of both `README.md` and
`README.zh.md`; hidden modes stay out of the public catalog. `AGENTS.md` links
to that catalog instead of duplicating the list. `CLAUDE.md` remains the single
