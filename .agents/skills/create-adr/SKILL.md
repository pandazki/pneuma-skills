---
name: create-adr
description: Create an Architecture Decision Record for Pneuma Skills. Use when the user asks to document an architecture decision or author an ADR.
---
...
7. Show or link the result for review. Commit only if the active task already includes committing; do not ask again for authorization already provided.
