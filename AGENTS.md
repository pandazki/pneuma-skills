...
**Builtin Modes:** `webcraft`, `doc`, `slide`, `draw`, `diagram`, `illustrate`, `remotion`, `gridboard`, `kami`, `clipcraft`, `cosmos`, `palate`, `mode-maker`, `evolve`, `project-evolve`, `project-onboard`, `project-tidy`
