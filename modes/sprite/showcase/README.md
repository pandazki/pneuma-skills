...
composed around **real sprite assets that already existed**. Not one pixel was
generated for the showcase: every sheet, frame, clip and reference here is
output from a run of the mode that happened for its own reasons.
...
|---|---|
| `hero.png` | `hero` |
| `highlight-character-locked-sheets.png` | `character-locked` |
