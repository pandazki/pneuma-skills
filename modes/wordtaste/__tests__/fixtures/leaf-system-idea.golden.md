...
Two things are hard constraints: the meaning of the author's material must survive, and no factual claim it does not support may enter. The development — the reasoning, the transitions, the examples — is yours to write; everything stylistic is taste.
