/**
 * skins — the curated reading-surface theme set for the Palate draft column.
 *
...
export function skinCssVars(skin: Skin): Record<string, string> {
  return {
    "--palate-skin-mode": skin.mode,
    "--palate-skin-bg": skin.palette.bg,
    "--palate-skin-fg": skin.palette.fg,
    "--palate-skin-muted": skin.palette.muted,
    "--palate-skin-heading": skin.palette.heading,
    "--palate-skin-accent": skin.palette.accent,
    "--palate-skin-rule": skin.palette.rule,
    "--palate-skin-wash": skin.palette.wash,
    "--palate-skin-font": skin.fontFamily,
    "--palate-skin-measure": skin.measure,
    "--palate-skin-line": String(skin.lineHeight),
  };
}
