...
const backlotManifest: ModeManifest = {
  ...
  changelog: {
    "0.1.0": [
      ...
      "Continuity is a decision, not a rule: a shot declares `continuity` only when the cut carries one action into a new camera, and then it is shot after the previous one, its prompt opens on that frame, and `take-handoff` is checked from an out-frame | in-frame strip — an ellipsis or a montage declares nothing",
