  ...
  viewerApi: {
    ...
    actions: [
      ...
      },
      {
        ...
        params: {},
        description:
          "Restart the scene iframe now. Use it after a batch of edits or a new GLB, when you want the reload to happen at a moment you chose; the viewer otherwise reloads on its own 1.5 s after the last scene file stops changing.",
      },
    ],
