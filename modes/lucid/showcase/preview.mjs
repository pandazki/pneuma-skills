...
const artwork = resolve(process.argv[2] ?? ".tmp-lucid-showcase");
const fonts = resolve(here, "../../../public/fonts");
const server = Bun.serve({
  hostname: "127.0.0.1", port: Number(process.env.SHOWCASE_PORT ?? 18144),
  async fetch(req) {
...
console.log("Views: hero, locked-target, wipe-compare, fresh-judge, asset-ladder");
