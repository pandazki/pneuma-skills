...
If `{{config_file}}` contains a `## Design Context` section (generated by the `teach` command), derive 1–2 additional personas from the audience and brand information:
