...
**Why**: Pneuma's workspace is organized around content sets — each is a self-contained, switchable project. Importing into a content set (rather than dumping files at the root) preserves the seed templates, enables side-by-side comparison between sets, and ensures all built-in features (set switching, per-set theming, export) work correctly.`,
  ...
  viewerApi: {
    ...
    commands: [
      { id: "teach-impeccable", label: "Teach Impeccable", description: "Gather design context for the project and establish persistent design guidelines" },
      ...
      { id: "normalize", label: "Normalize", description: "Align design to match design system standards and ensure consistency" },
      { id: "polish", label: "Polish", description: "Final quality pass fixing alignment, spacing, consistency, and detail issues" },
      ...
      { id: "typeset", label: "Typeset", description: "Improve typography by fixing font choices, hierarchy, sizing, weight consistency, and readability" },
      { id: "arrange", label: "Arrange", description: "Improve layout, spacing, and visual rhythm for intentional compositions" },
      { id: "optimize", label: "Optimize", description: "Improve performance across loading speed, rendering, animations, and bundle size" },
      { id: "harden", label: "Harden", description: "Improve resilience through error handling, i18n, text overflow, and edge cases" },
      ...
      { id: "onboard", label: "Onboard", description: "Design or improve onboarding flows, empty states, and first-time user experiences" },
    ],
  },
