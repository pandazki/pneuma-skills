...
| 7 | Fake decimal precision | "Market share: 23.7%" with no cited source | Verify the figure and cite its source, or mark it `[DATA NEEDED]`; rounding does not make an unsupported number valid |
