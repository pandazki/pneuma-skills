...
The per-row limits above are the resume rule and the only one that applies here.
For prose density anywhere else, `writing.md` «Emphasis rhythm» is the single
source — do not carry a second ratio around.
