...
export interface ManagerOptions {
  ...
  videoAhead?: number;
  planAhead?: number;
  /** "locked" (default): every shot reference-to-video with the voice reference and character sheet; "fast": image-to-video inside a scene, no voice reference. */
  continuity?: "locked" | "fast";
